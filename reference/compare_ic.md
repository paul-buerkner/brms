...
#> Chain 1: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 1: 
#> Chain 1:  Elapsed Time: 1.434 seconds (Warm-up)
...
#> Chain 3:                1.356 seconds (Sampling)
#> Chain 3:                2.904 seconds (Total)
#> Chain 3: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 4).
#> Chain 4: 
...
#> Chain 4: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 4: 
#> Chain 4:  Elapsed Time: 1.476 seconds (Warm-up)
#> Chain 4:                0.703 seconds (Sampling)
#> Chain 4:                2.179 seconds (Total)
#> Chain 4: 
waic2 <- waic(fit2)
#> Warning: 
