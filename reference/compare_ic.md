...
#> Chain 2: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 2: 
#> Chain 2:  Elapsed Time: 1.572 seconds (Warm-up)
#> Chain 2:                0.758 seconds (Sampling)
#> Chain 2:                2.33 seconds (Total)
#> Chain 2: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 3).
#> Chain 3: 
...
#> Chain 3:                1.47 seconds (Sampling)
#> Chain 3:                3.117 seconds (Total)
#> Chain 3: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 4).
#> Chain 4: 
...
#> Chain 4: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 4: 
#> Chain 4:  Elapsed Time: 1.569 seconds (Warm-up)
#> Chain 4:                0.759 seconds (Sampling)
#> Chain 4:                2.328 seconds (Total)
#> Chain 4: 
waic2 <- waic(fit2)
#> Warning: 
