...
#> Chain 1: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 1: 
#> Chain 1:  Elapsed Time: 0.702 seconds (Warm-up)
...
#> Chain 3: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 3: 
#> Chain 3:  Elapsed Time: 0.752 seconds (Warm-up)
#> Chain 3:                0.698 seconds (Sampling)
#> Chain 3:                1.45 seconds (Total)
#> Chain 3: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 4).
#> Chain 4: 
...
#> Chain 4:                0.357 seconds (Sampling)
#> Chain 4:                1.072 seconds (Total)
#> Chain 4: 
waic2 <- waic(fit2)
#> Warning: 
