...
#> Chain 2:                0.584 seconds (Sampling)
...
#> Chain 3: 
#> Chain 3:  Elapsed Time: 0.692 seconds (Warm-up)
#> Chain 3:                0.573 seconds (Sampling)
#> Chain 3:                1.265 seconds (Total)
#> Chain 3: 
#> 
...
#> Chain 4: 
#> Chain 4:  Elapsed Time: 0.709 seconds (Warm-up)
#> Chain 4:                0.73 seconds (Sampling)
#> Chain 4:                1.439 seconds (Total)
#> Chain 4: 
summary(fit)
...
#> Chain 2: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 2: 
#> Chain 2:  Elapsed Time: 0.543 seconds (Warm-up)
...
#> Chain 3:                0.545 seconds (Sampling)
#> Chain 3:                1.085 seconds (Total)
#> Chain 3: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 4).
#> Chain 4: 
...
#> Chain 4:                0.555 seconds (Sampling)
#> Chain 4:                1.096 seconds (Total)
#> Chain 4: 
summary(fit_vec)
#>  Family: beta_binomial2 
#>   Links: mu = logit 
