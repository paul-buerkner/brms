...
#> Chain 1: 
#> Chain 1:  Elapsed Time: 0.73 seconds (Warm-up)
#> Chain 1:                0.656 seconds (Sampling)
...
#> Chain 3:                0.661 seconds (Sampling)
#> Chain 3:                1.382 seconds (Total)
#> Chain 3: 
#> 
...
#> Chain 4:                0.648 seconds (Sampling)
...
#> Chain 3: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 3: 
#> Chain 3:  Elapsed Time: 0.512 seconds (Warm-up)
#> Chain 3:                0.528 seconds (Sampling)
#> Chain 3:                1.04 seconds (Total)
#> Chain 3: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 4).
#> Chain 4: 
