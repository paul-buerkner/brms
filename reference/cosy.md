...
#> Chain 1: 
#> Chain 1: Gradient evaluation took 0.00185 seconds
#> Chain 1: 1000 transitions using 10 leapfrog steps per transition would take 18.5 seconds.
...
#> Chain 1:                2.511 seconds (Sampling)
#> Chain 1:                4.89 seconds (Total)
#> Chain 1: 
#> 
...
#> Chain 2: 
#> Chain 2:  Elapsed Time: 2.356 seconds (Warm-up)
#> Chain 2:                2.265 seconds (Sampling)
...
#> Chain 3:                2.251 seconds (Sampling)
#> Chain 3:                4.633 seconds (Total)
#> Chain 3: 
#> 
...
#> Chain 4: 
#> Chain 4:  Elapsed Time: 2.544 seconds (Warm-up)
