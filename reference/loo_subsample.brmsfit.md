...
#> Chain 1:                0.684 seconds (Sampling)
#> Chain 1:                2.094 seconds (Total)
#> Chain 1: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 2).
#> Chain 2: 
...
#> Chain 2:                0.683 seconds (Sampling)
...
#> Chain 3: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 3: 
#> Chain 3:  Elapsed Time: 1.363 seconds (Warm-up)
#> Chain 3:                0.68 seconds (Sampling)
#> Chain 3:                2.043 seconds (Total)
#> Chain 3: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 4).
#> Chain 4: 
...
#> Chain 4: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 4: 
#> Chain 4:  Elapsed Time: 1.401 seconds (Warm-up)
#> Chain 4:                0.68 seconds (Sampling)
#> Chain 4:                2.081 seconds (Total)
#> Chain 4: 
