...
#> Chain 1: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 1: 
#> Chain 1:  Elapsed Time: 1.591 seconds (Warm-up)
#> Chain 1:                0.771 seconds (Sampling)
#> Chain 1:                2.362 seconds (Total)
#> Chain 1: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 2).
#> Chain 2: 
...
#> Chain 2:                0.769 seconds (Sampling)
#> Chain 2:                2.311 seconds (Total)
#> Chain 2: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 3).
#> Chain 3: 
