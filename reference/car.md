...
#> Chain 1: 
#> Chain 1: Gradient evaluation took 0.002151 seconds
#> Chain 1: 1000 transitions using 10 leapfrog steps per transition would take 21.51 seconds.
...
#> Chain 2: 
#> Chain 2:  Elapsed Time: 0.776 seconds (Warm-up)
#> Chain 2:                0.585 seconds (Sampling)
#> Chain 2:                1.361 seconds (Total)
#> Chain 2: 
#> 
...
#> Chain 3:                0.558 seconds (Sampling)
#> Chain 3:                1.217 seconds (Total)
#> Chain 3: 
#> 
