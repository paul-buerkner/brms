...
#> Chain 1: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 1: 
#> Chain 1:  Elapsed Time: 1.419 seconds (Warm-up)
#> Chain 1:                0.696 seconds (Sampling)
#> Chain 1:                2.115 seconds (Total)
#> Chain 1: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 2).
#> Chain 2: 
...
#> Chain 2: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 2: 
#> Chain 2:  Elapsed Time: 1.479 seconds (Warm-up)
#> Chain 2:                0.696 seconds (Sampling)
#> Chain 2:                2.175 seconds (Total)
#> Chain 2: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 3).
#> Chain 3: 
...
#> Chain 3: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 3: 
#> Chain 3:  Elapsed Time: 1.452 seconds (Warm-up)
#> Chain 3:                0.698 seconds (Sampling)
#> Chain 3:                2.15 seconds (Total)
#> Chain 3: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 4).
#> Chain 4: 
...
#> Chain 4: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 4: 
#> Chain 4:  Elapsed Time: 1.517 seconds (Warm-up)
#> Chain 4:                0.697 seconds (Sampling)
#> Chain 4:                2.214 seconds (Total)
#> Chain 4: 
