...
#> Chain 3: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 3: 
#> Chain 3:  Elapsed Time: 0.715 seconds (Warm-up)
#> Chain 3:                0.343 seconds (Sampling)
#> Chain 3:                1.058 seconds (Total)
#> Chain 3: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 4).
#> Chain 4: 
...
#> Chain 4: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 4: 
#> Chain 4:  Elapsed Time: 0.752 seconds (Warm-up)
#> Chain 4:                0.34 seconds (Sampling)
#> Chain 4:                1.092 seconds (Total)
#> Chain 4: 
