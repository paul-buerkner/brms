...
#> Chain 2:                0.662 seconds (Sampling)
#> Chain 2:                2.077 seconds (Total)
#> Chain 2: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 3).
#> Chain 3: 
...
#> Chain 3:                0.663 seconds (Sampling)
...
#> Chain 4: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 4: 
#> Chain 4:  Elapsed Time: 1.447 seconds (Warm-up)
#> Chain 4:                0.662 seconds (Sampling)
#> Chain 4:                2.109 seconds (Total)
#> Chain 4: 
