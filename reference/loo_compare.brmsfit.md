...
#> Chain 2:                0.76 seconds (Sampling)
#> Chain 2:                2.393 seconds (Total)
#> Chain 2: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 3).
#> Chain 3: 
...
#> Chain 3: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 3: 
#> Chain 3:  Elapsed Time: 1.602 seconds (Warm-up)
#> Chain 3:                0.76 seconds (Sampling)
#> Chain 3:                2.362 seconds (Total)
#> Chain 3: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 4).
#> Chain 4: 
...
#> Chain 4: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 4: 
#> Chain 4:  Elapsed Time: 1.668 seconds (Warm-up)
#> Chain 4:                0.76 seconds (Sampling)
#> Chain 4:                2.428 seconds (Total)
#> Chain 4: 
