...
#> Chain 1: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 1: 
#> Chain 1:  Elapsed Time: 1.561 seconds (Warm-up)
...
#> Chain 2:                0.757 seconds (Sampling)
#> Chain 2:                2.388 seconds (Total)
#> Chain 2: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 3).
#> Chain 3: 
...
#> Chain 3: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 3: 
#> Chain 3:  Elapsed Time: 1.579 seconds (Warm-up)
#> Chain 3:                0.742 seconds (Sampling)
#> Chain 3:                2.321 seconds (Total)
#> Chain 3: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 4).
#> Chain 4: 
...
#> Chain 4: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 4: 
#> Chain 4:  Elapsed Time: 1.651 seconds (Warm-up)
#> Chain 4:                0.744 seconds (Sampling)
#> Chain 4:                2.395 seconds (Total)
#> Chain 4: 
