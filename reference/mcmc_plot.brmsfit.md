...
#> Chain 1: 
#> Chain 1:  Elapsed Time: 1.91 seconds (Warm-up)
#> Chain 1:                1.433 seconds (Sampling)
#> Chain 1:                3.343 seconds (Total)
#> Chain 1: 
#> 
...
#> Chain 2:                1.352 seconds (Sampling)
#> Chain 2:                3.025 seconds (Total)
#> Chain 2: 
#> 
...
#> Chain 3:                1.349 seconds (Sampling)
#> Chain 3:                3.185 seconds (Total)
#> Chain 3: 
#> 
...
#> Chain 4:                1.35 seconds (Sampling)
#> Chain 4:                3.273 seconds (Total)
#> Chain 4: 
