...
#> Chain 1: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 1: 
#> Chain 1:  Elapsed Time: 2.335 seconds (Warm-up)
#> Chain 1:                1.636 seconds (Sampling)
#> Chain 1:                3.971 seconds (Total)
#> Chain 1: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 2).
#> Chain 2: 
...
#> Chain 2: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 2: 
#> Chain 2:  Elapsed Time: 2.291 seconds (Warm-up)
#> Chain 2:                1.536 seconds (Sampling)
#> Chain 2:                3.827 seconds (Total)
#> Chain 2: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 3).
#> Chain 3: 
...
#> Chain 3: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 3: 
#> Chain 3:  Elapsed Time: 2.314 seconds (Warm-up)
#> Chain 3:                1.596 seconds (Sampling)
#> Chain 3:                3.91 seconds (Total)
#> Chain 3: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 4).
#> Chain 4: 
...
#> Chain 4: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 4: 
#> Chain 4:  Elapsed Time: 2.255 seconds (Warm-up)
#> Chain 4:                1.568 seconds (Sampling)
#> Chain 4:                3.823 seconds (Total)
#> Chain 4: 
summary(fit2)
#>  Family: poisson 
#>   Links: mu = log 
