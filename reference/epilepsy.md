...
#> Chain 1: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 1: 
#> Chain 1:  Elapsed Time: 2.217 seconds (Warm-up)
#> Chain 1:                1.56 seconds (Sampling)
#> Chain 1:                3.777 seconds (Total)
#> Chain 1: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 2).
#> Chain 2: 
...
#> Chain 2: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 2: 
#> Chain 2:  Elapsed Time: 2.188 seconds (Warm-up)
#> Chain 2:                1.465 seconds (Sampling)
#> Chain 2:                3.653 seconds (Total)
#> Chain 2: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 3).
#> Chain 3: 
...
#> Chain 3: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 3: 
#> Chain 3:  Elapsed Time: 2.213 seconds (Warm-up)
#> Chain 3:                1.52 seconds (Sampling)
#> Chain 3:                3.733 seconds (Total)
#> Chain 3: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 4).
#> Chain 4: 
...
#> Chain 4: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 4: 
#> Chain 4:  Elapsed Time: 2.159 seconds (Warm-up)
#> Chain 4:                1.498 seconds (Sampling)
#> Chain 4:                3.657 seconds (Total)
#> Chain 4: 
summary(fit2)
#>  Family: poisson 
#>   Links: mu = log 
