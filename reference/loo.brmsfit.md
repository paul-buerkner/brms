...
#> Chain 2:                0.669 seconds (Sampling)
#> Chain 2:                2.084 seconds (Total)
#> Chain 2: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 3).
#> Chain 3: 
...
#> Chain 3: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 3: 
#> Chain 3:  Elapsed Time: 1.609 seconds (Warm-up)
#> Chain 3:                1.354 seconds (Sampling)
#> Chain 3:                2.963 seconds (Total)
#> Chain 3: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 4).
#> Chain 4: 
...
#> Chain 4:                0.671 seconds (Sampling)
#> Chain 4:                2.021 seconds (Total)
#> Chain 4: 
