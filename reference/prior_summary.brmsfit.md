...
#> Chain 1:                3.526 seconds (Sampling)
#> Chain 1:                7.744 seconds (Total)
#> Chain 1: 
#> 
...
#> Chain 2: 
#> Chain 2:  Elapsed Time: 4.23 seconds (Warm-up)
#> Chain 2:                2.5 seconds (Sampling)
#> Chain 2:                6.73 seconds (Total)
#> Chain 2: 
#> 
...
#> Chain 3: 
#> Chain 3:  Elapsed Time: 4.103 seconds (Warm-up)
#> Chain 3:                2.508 seconds (Sampling)
#> Chain 3:                6.611 seconds (Total)
#> Chain 3: 
#> 
...
#> Chain 4:                2.488 seconds (Sampling)
