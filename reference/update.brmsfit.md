...
#> Chain 1: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 1: 
#> Chain 1:  Elapsed Time: 2.649 seconds (Warm-up)
#> Chain 1:                3.944 seconds (Sampling)
#> Chain 1:                6.593 seconds (Total)
#> Chain 1: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 2).
#> Chain 2: 
...
#> Chain 2:                4.42 seconds (Sampling)
#> Chain 2:                4.883 seconds (Total)
#> Chain 2: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 3).
#> Chain 3: 
...
#> Chain 3:                3.303 seconds (Sampling)
...
#> Chain 4: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 4: 
#> Chain 4:  Elapsed Time: 2.361 seconds (Warm-up)
#> Chain 4:                4.236 seconds (Sampling)
#> Chain 4:                6.597 seconds (Total)
#> Chain 4: 
...
#> Chain 3: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 3: 
#> Chain 3:  Elapsed Time: 1.293 seconds (Warm-up)
#> Chain 3:                0.514 seconds (Sampling)
#> Chain 3:                1.807 seconds (Total)
#> Chain 3: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 4).
#> Chain 4: 
