...
#> Chain 2:                2.87 seconds (Sampling)
#> Chain 2:                5.704 seconds (Total)
#> Chain 2: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 3).
#> Chain 3: Rejecting initial value:
...
#> Chain 3:                2.901 seconds (Sampling)
#> Chain 3:                5.64 seconds (Total)
#> Chain 3: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 4).
...
#> Chain 4: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 4: 
#> Chain 4:  Elapsed Time: 2.789 seconds (Warm-up)
#> Chain 4:                2.867 seconds (Sampling)
#> Chain 4:                5.656 seconds (Total)
#> Chain 4: 
summary(fit4)
#>  Family: poisson 
#>   Links: mu = log 
