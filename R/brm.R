...
#'   \proglang{Stan}'s program blocks.
#' @param stan_funs (Deprecated) An optional character string containing
#'   self-defined  \proglang{Stan} functions, which will be included in the functions
#'   block of the generated \proglang{Stan} code. It is now recommended to use the
...
#'
#'   \bold{Adjusting the sampling behavior of \proglang{Stan}}
#'
...
#'   \proglang{Stan} will throw out a warning suggesting to increase
