   ...
   *   log(P(Y <= y))
   */ 
   real exgaussian_lcdf(real y, real eta, real sigma, real beta) { 
     real mu;
     real z;
     mu = eta - beta;
     z = y - mu - sigma^2 / beta;
   ...
   *   log(P(Y > y))
   */ 
   real exgaussian_lccdf(real y, real eta, real sigma, real beta) { 
     real mu;
     real z;
     mu = eta - beta;
     z = y - mu - sigma^2 / beta;
