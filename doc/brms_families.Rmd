...
into 2 groups, one for cured and the other for uncured, with incidence probability $\pi$, with
the uncured part having a proper time-to-event density. These models only make sense in the presence
of right-censoring. Let $y$ be the observed time (event or censoring), $t$ be the (partially latent)
...
incidence part, repsectively. Currently implemented families are **mixcure_lognormal** and **mixcure_weibull**.
