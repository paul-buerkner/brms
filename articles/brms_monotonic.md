...
```
    ...
    Intercept    30.84      1.45    27.99    33.68 1.00     2560     2497
    moincome     15.20      0.70    13.82    16.54 1.00     2238     2552

    Monotonic Simplex Parameters:
                 Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    moincome1[1]     0.65      0.04     0.57     0.72 1.00     4184     2829
    moincome1[2]     0.24      0.04     0.16     0.33 1.00     2800     2048
    moincome1[3]     0.11      0.04     0.03     0.19 1.00     2757     1973

    Further Distributional Parameters:
          Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    sigma     7.13      0.52     6.21     8.23 1.00     3534     2653
...
```
    ...
    Regression Coefficients:
              Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    Intercept    30.81      1.46    27.98    33.73 1.00     2810     2016
    moincome     15.18      0.70    13.82    16.50 1.00     2129     2435

    Monotonic Simplex Parameters:
                 Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    moincome1[1]     0.65      0.04     0.58     0.73 1.00     3327     2749
    moincome1[2]     0.24      0.04     0.15     0.32 1.00     2608     2162
    moincome1[3]     0.11      0.04     0.02     0.19 1.00     2103     1306

    Further Distributional Parameters:
          Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    sigma     7.12      0.52     6.18     8.23 1.00     3149     2253
...
```
    ...
    Regression Coefficients:
                 Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    Intercept       25.48      5.19    14.91    35.41 1.00     1181     2130
    age              0.13      0.12    -0.10     0.39 1.00     1137     1903
    moincome        17.00      2.59    12.15    22.26 1.00      939     1259
    moincome:age    -0.04      0.06    -0.17     0.07 1.00      948     1246

    Monotonic Simplex Parameters:
                     Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    moincome1[1]         0.63      0.06     0.52     0.76 1.00     1638     1496
    moincome1[2]         0.25      0.05     0.15     0.35 1.00     2310     2193
    moincome1[3]         0.12      0.05     0.02     0.23 1.00     1550      926
    moincome:age1[1]     0.39      0.25     0.02     0.87 1.00     2279     2120
    moincome:age1[2]     0.32      0.23     0.01     0.84 1.00     2378     2308
    moincome:age1[3]     0.29      0.22     0.01     0.79 1.00     2497     2232

    Further Distributional Parameters:
          Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    sigma     7.13      0.52     6.20     8.22 1.00     3144     3073
...
```
    ...
    ~city (Number of levels: 10) 
                            Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    sd(Intercept)              16.83      4.76    10.02    28.07 1.01     1190     1971
    sd(moincome)                1.30      1.05     0.05     3.81 1.00     1277     1757
    cor(Intercept,moincome)    -0.23      0.50    -0.95     0.84 1.00     4104     2582

    Regression Coefficients:
                 Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    Intercept       21.66      7.40     7.37    36.51 1.00     1156     1590
    age              0.16      0.12    -0.07     0.40 1.00     1847     2427
    moincome        17.05      2.60    11.88    22.38 1.00     1597     1801
    moincome:age    -0.05      0.06    -0.18     0.07 1.00     1481     1648

    Monotonic Simplex Parameters:
                     Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    moincome1[1]         0.63      0.06     0.50     0.75 1.00     2155     1938
    moincome1[2]         0.25      0.06     0.14     0.37 1.00     2785     1962
    moincome1[3]         0.12      0.05     0.02     0.24 1.00     2612     1751
    moincome:age1[1]     0.34      0.23     0.01     0.83 1.00     3784     2243
    moincome:age1[2]     0.36      0.24     0.02     0.84 1.00     3462     2467
    moincome:age1[3]     0.30      0.22     0.01     0.78 1.00     4059     2646

    Further Distributional Parameters:
          Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    sigma     7.02      0.57     6.03     8.25 1.00     3919     2892
