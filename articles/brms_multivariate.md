...
```
    ...
    sd(tarsus_Intercept)                     0.48      0.05     0.39     0.59 1.00      745
    sd(back_Intercept)                       0.24      0.08     0.09     0.39 1.00      343
    cor(tarsus_Intercept,back_Intercept)    -0.53      0.23    -0.93    -0.08 1.00      542
                                         Tail_ESS
    sd(tarsus_Intercept)                     1117
    sd(back_Intercept)                        451
    cor(tarsus_Intercept,back_Intercept)      878

    ~fosternest (Number of levels: 104) 
                                         Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS
    sd(tarsus_Intercept)                     0.27      0.05     0.16     0.37 1.00      662
    sd(back_Intercept)                       0.35      0.06     0.24     0.47 1.00      453
    cor(tarsus_Intercept,back_Intercept)     0.70      0.20     0.25     0.98 1.00      326
                                         Tail_ESS
    sd(tarsus_Intercept)                     1033
    sd(back_Intercept)                       1173
    cor(tarsus_Intercept,back_Intercept)      543

    Regression Coefficients:
                     Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    tarsus_Intercept    -0.40      0.07    -0.54    -0.27 1.00     1735     1512
    back_Intercept      -0.02      0.07    -0.14     0.11 1.00     2741     1611
    tarsus_sexMale       0.77      0.06     0.66     0.88 1.00     3565     1514
    tarsus_sexUNK        0.23      0.12    -0.01     0.46 1.00     3920     1355
    tarsus_hatchdate    -0.04      0.06    -0.16     0.08 1.00     1859     1469
    back_sexMale         0.01      0.07    -0.13     0.14 1.00     4962     1596
    back_sexUNK          0.15      0.15    -0.14     0.44 1.00     4225     1877
    back_hatchdate      -0.09      0.05    -0.19     0.02 1.00     2018     1349

    Further Distributional Parameters:
                 Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    sigma_tarsus     0.76      0.02     0.71     0.80 1.00     2827     1285
    sigma_back       0.90      0.02     0.86     0.95 1.00     2343     1629

    Residual Correlations: 
                        Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    rescor(tarsus,back)    -0.05      0.04    -0.13     0.02 1.00     3072     1756
...
```
    ...
    R2tarsus 0.4335212 0.02658612 0.3787396 0.4822428
    R2back   0.1976118 0.02865240 0.1453363 0.2566764
...
```
    ...
    ~dam (Number of levels: 106) 
                                         Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS
    sd(tarsus_Intercept)                     0.48      0.05     0.39     0.58 1.00      663
    sd(back_Intercept)                       0.26      0.07     0.11     0.40 1.01      297
    cor(tarsus_Intercept,back_Intercept)    -0.50      0.22    -0.92    -0.07 1.00      627
                                         Tail_ESS
    sd(tarsus_Intercept)                     1337
    sd(back_Intercept)                        574
    cor(tarsus_Intercept,back_Intercept)      981

    ~fosternest (Number of levels: 104) 
                                         Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS
    sd(tarsus_Intercept)                     0.26      0.05     0.16     0.37 1.01      616
    sd(back_Intercept)                       0.34      0.06     0.23     0.45 1.00      463
    cor(tarsus_Intercept,back_Intercept)     0.69      0.21     0.20     0.98 1.02      268
                                         Tail_ESS
    sd(tarsus_Intercept)                     1270
    sd(back_Intercept)                        938
    cor(tarsus_Intercept,back_Intercept)      605

    Regression Coefficients:
                     Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    tarsus_Intercept    -0.41      0.07    -0.55    -0.27 1.00     1939     1543
    back_Intercept       0.00      0.05    -0.10     0.11 1.00     2093     1365
    tarsus_sexMale       0.77      0.06     0.66     0.88 1.00     3103     1360
    tarsus_sexUNK        0.22      0.13    -0.03     0.48 1.00     4122     1621
    back_hatchdate      -0.08      0.05    -0.19     0.02 1.00     2961     1551

    Further Distributional Parameters:
                 Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    sigma_tarsus     0.76      0.02     0.72     0.80 1.00     2585     1718
    sigma_back       0.90      0.03     0.85     0.95 1.00     2794     1379

    Residual Correlations: 
                        Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    rescor(tarsus,back)    -0.05      0.04    -0.13     0.02 1.00     2722     1505
...
```
    ...
    Model comparisons:
     model elpd_diff se_diff p_worse       diag_diff      diag_elpd
      fit2       0.0     0.0      NA                               
      fit1      -2.4     1.4    0.96 |elpd_diff| < 4 3 k_psis > 0.7
...
```
    ...
    Smoothing Spline Hyperparameters:
                           Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    sds(back_shatchdate_1)     1.98      1.01     0.40     4.31 1.01      510      558

    Multilevel Hyperparameters:
    ~dam (Number of levels: 106) 
                                         Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS
    sd(tarsus_Intercept)                     0.47      0.05     0.38     0.57 1.00      695
    sd(back_Intercept)                       0.23      0.07     0.09     0.36 1.01      254
    cor(tarsus_Intercept,back_Intercept)    -0.53      0.23    -0.94    -0.07 1.01      444
                                         Tail_ESS
    sd(tarsus_Intercept)                     1250
    sd(back_Intercept)                        551
    cor(tarsus_Intercept,back_Intercept)      652

    ~fosternest (Number of levels: 104) 
                                         Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS
    sd(tarsus_Intercept)                     0.26      0.05     0.16     0.37 1.01      369
    sd(back_Intercept)                       0.31      0.06     0.20     0.43 1.00      599
    cor(tarsus_Intercept,back_Intercept)     0.66      0.22     0.18     0.97 1.00      266
                                         Tail_ESS
    sd(tarsus_Intercept)                      625
    sd(back_Intercept)                       1112
    cor(tarsus_Intercept,back_Intercept)      649

    Regression Coefficients:
                         Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    tarsus_Intercept        -0.41      0.07    -0.53    -0.28 1.00     1160     1029
    back_Intercept           0.00      0.05    -0.10     0.10 1.01     1545     1411
    tarsus_sexMale           0.77      0.06     0.66     0.88 1.00     3405     1520
    tarsus_sexUNK            0.22      0.12    -0.02     0.44 1.00     2468     1510
    sigma_tarsus_sexFem     -0.30      0.04    -0.39    -0.22 1.00     2502     1745
    sigma_tarsus_sexMale    -0.25      0.04    -0.32    -0.17 1.00     2671     1696
    sigma_tarsus_sexUNK     -0.39      0.13    -0.63    -0.15 1.00     2323     1761
    back_shatchdate_1       -0.26      2.97    -5.71     6.14 1.00      975      888

    Further Distributional Parameters:
                 Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    sigma_back       0.90      0.02     0.86     0.95 1.00     2785     1407
    alpha_tarsus    -1.24      0.40    -1.89    -0.07 1.00     1413      709
