...
$$f(y_i) = \frac{1}{2 \beta} \exp\left(\frac{1}{2 \beta} \left(2\mu + \sigma^2 / \beta - 2 y_i \right) \right) \text{erfc}\left(\frac{\mu + \sigma^2 / \beta - y_i}{\sqrt{2} \sigma} \right)$$

where $\beta$ is the scale (inverse rate) of the exponential component, $\mu = g(\eta_i) - \beta$ is the mean of the Gaussian componenent, $\sigma$ is the standard deviation of the Gaussian component, and $\text{erfc}$ is the complementary error function.
